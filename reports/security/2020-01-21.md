...
Public and Info are set for integration testing and cardano-wallet-itn - here we can set it via command line options: https://github.com/input-output-hk/cardano-wallet/blob/master/lib/jormungandr/exe/cardano-wallet-itn.hs#L360). Also, we do care that some values are never shown : https://github.com/input-output-hk/cardano-wallet/blob/master/lib/core/src/Cardano/Wallet/Api/Server.hs#L351-L358
...
Logging in lib/jormungandr/exe/cardano-wallet-itn.hs, lib/core/src/Cardano/Wallet/Network.hs and lib/cli/src/Cardano/CLI.hs does not contribute to revealing of API calls info at all.
