...
benchmarkIndexFromMap = do
  ...
  let
    utxoMapAdaOnly___1_000 = makeUTxOMapAdaOnly 1_000
  let
    utxoMapAdaOnly__10_000 = makeUTxOMapAdaOnly 10_000
  let
    utxoMapAdaOnly_100_000 = makeUTxOMapAdaOnly 100_000

  let
    utxoMapNFTs___1_000 = makeUTxOMapNFTs 1_000
  let
    utxoMapNFTs__10_000 = makeUTxOMapNFTs 10_000
  let
    utxoMapNFTs_100_000 = makeUTxOMapNFTs 100_000
