...
checkCoverage_select u s =
    checkCoverage
        . cover
            10
            (UTxOSelection.isLeftover u s)
            "in leftover set"
        . cover
            10
            (UTxOSelection.isSelected u s)
            "in selected set"
        . cover
            10
            (not (UTxOSelection.isMember u s))
            "in neither set"
...
instance (Arbitrary u, Ord u, Show u) => Arbitrary (UTxOSelectionNonEmpty u) where
