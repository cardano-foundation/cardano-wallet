...
newtype ErrNoSuchWallet
    = ErrNoSuchWallet AccountId -- Wallet is gone or doesn't exist yet
    deriving (Eq, Show)
...
newtype ErrWalletAlreadyExists
    = ErrWalletAlreadyExists AccountId -- Wallet already exists in db
    deriving (Eq, Show)
