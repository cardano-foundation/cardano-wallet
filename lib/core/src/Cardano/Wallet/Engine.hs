...
-- | Initialise and store a new wallet, returning its ID. The wallet is ready
-- to be used once the function has returned. The function registers a worker
-- to the 'WorkerRegistry' which is needed to get any database handle for the
