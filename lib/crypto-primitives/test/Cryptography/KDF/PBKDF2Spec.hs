...
spec = do
    describe "Golden Tests obtained by openssl" $ do
        ...
        it "golden 2"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "8C0A769589C080CD70BE80EE380E28C6DFB4430B19FBAAE0D718BFB4CD5228B1"
        ...
        it "golden 3"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "F4CA507C07D0BD31BC779A08756826A6FD9DD97D43AC25E4B29A0933ABEA03F3"
        ...
        it "golden 4"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "ECC1A2E6F16D6420F9A953AD8A80FDD0D8AC12839E964C0D132C25047B430FFD"
        ...
        it "golden 10"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "3BE342BC36004A2F34B8FAD4BDCA91AE3495A946CF7C0DD789EDE283AF8A3EE1"
                , iv = ""
                }
        ...
        it "golden 11"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "A0BEF9E8434D518A2D9BCCF7883808BEDC5093E678AC7AC3CA1C6F7071B49575"
                , iv = ""
                }
        ...
        it "golden 12"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "0DB80B6BC6D151C4FA474E8533DD2D4172208B895BBDB1D7ED564B1817F50B51"
                , iv = ""
                }
        ...
        it "golden Byron"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "6D3FF0C9AAE42F26B518C4E9F98D1A1EAB59B55E5A82F78F66DFC7CAA956DCA0"
                , iv = ""
                }
        ...
        it "golden Icarus"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "E0FB520D01112056904730F762AD263B806953F1FE5B4662C97B1F301BB5F862"
                , iv = ""
                }
        ...
        it "golden CIP83"
            ...
            `shouldBe` OpenSSLOutput
                { key =
                    "6BBCD65DA84D7BB1D214908270352A56FF25B375E53B7D3F237330666CCBF0DF"
                , iv = "FD40C29618D438E3658388C52EB7974E"
                }

    describe
        "password and password padded with \NUL produce the same (key, iv) pair"
        $ it
            "generateKey conf passwd salt == generateKey conf (passwd <> \NUL <> ...) salt"
