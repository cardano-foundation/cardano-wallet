...
spec = do
    ...
    describe "Golden Tests - Cardano-SL - signed tx (Mainnet)" $ do
        ...
        goldenTestSignedTx proxy 1
            [ (xprv "address-number-0", Coin 42) ]
            "82839f8200d81858248258203b40265111d8bb3c3c608d95b3a0bf83461ace\
            \32d79336579a1939b3aad1c0b700ff9f8282d818582183581cb0e693cbc9727\
            \2bd42aacf3b443ecac68b96b4fa20159186a4a38883a0001a497c15c6182aff\
            \a0818200d81858858258408e620235b2a427259cc1a1c63af9ef179cb3b6e39\
            \6da182e01d65dd3ed7be94be25db39fb78e74d4b53fb51776d0f5eb360e62d0\
            \9b853f3a87ac25bf834ee1fb58403684501a21346ba3c19a6dc3479180e80a14\
            \e5edc0ffb4b1469abe0332e7e1caf291d50cb8d2c47ee37f6b44b7fbfcc5a1b0\
            \1bc262038e93969b9a728a2b3500"

        goldenTestSignedTx proxy 2
            [ (xprv "address-number-0", Coin 42)
    ...
    in
        counterexample debug $
            (calcSize >= realSizeInf && calcSize <= realSizeSup, encodedTx) ===
                (True, encodedTx)
  where
    dummyWitness = TxWitness $ "\130"
        <>
        "X@\226E\220\252\DLE\170\216\210\164\155\182mm$ePG\252\186\195\225_\b=\v\241=\255 \208\147[\239\RS\170|\214\202\247\169\229\205\187O_)\221\175\155?e\198\248\170\157-K\155\169z\144\174\ENQh"
        <>
        "X@\193\151*,\NULz\205\234\&1tL@\211\&2\165\129S\STXP\164C\176 Xvf\160|;\CANs{\SYN\204<N\207\154\130\225\229\t\172mbC\139\US\159\246\168x\163Mq\248\145)\160|\139\207-\SI"
    fromCoinSelection (CoinSelection inps outs chngs) =
        let
            txChngs = zipWith TxOut
                (take (length chngs) (chngAddrs <*> pure (networkVal @n)))
                chngs
...
goldenTestSignedTx
    ...
    -> SpecWith ()
goldenTestSignedTx _ nOuts xprvs expected = it title $ do
    let addrs = first (keyToAddress @(HttpBridge n) . publicKey) <$> xprvs
