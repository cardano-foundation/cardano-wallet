...
spec = do
            ...
            it "golden2.json - Valid WKP" $ do
                ...
                map metadataFromProperties rs
                    `shouldBe` [ Just golden1Metadata0
                               ...
                               , Nothing
                               , Just
                                    (AssetMetadata "Token2" "description2" Nothing Nothing Nothing Nothing)
                               ]
    ...
    traceSpec $ describe "Using mock server" $ do
        ...
        it
            "ill-formatted entry doesn't make the entire response fail to parse"
            $ \tr -> do
    ...
    golden1Properties =
        ...
        , SubjectProperties
            ...
            , properties =
                ...
                , Just
                    $ Property
                        (Right (AssetLogo $ unsafeFromBase64 "QWxtb3N0IGEgbG9nbw=="))
                        []
                        0
