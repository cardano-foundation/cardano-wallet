...
spec = do
    describe "Buildable instances examples" $ do
        ...
        let utxo = utxoFromTx $ case transactions block of
                (t : _) -> t
                [] -> error "expected transactions"
...
prop_countRewardsOnce (WithPending wallet pending rewards) =
    withMaxSuccess 1000
        ...
        $ counterexample
            ("Total Rewards:              " <> show (unCoin rewards))
        $ counterexample
            ("Total Balance (w/ pending): " <> show totalWithPending)
        $ counterexample
            ("Total Balance (no pending): " <> show totalWithoutPending)
...
deriving instance
    (Eq (Fun a Bool), Eq (Fun b Bool)) => Eq (IsOursIf2 a b)
deriving instance
    (Show (Fun a Bool), Show (Fun b Bool)) => Show (IsOursIf2 a b)
...
isOursIf
    :: (a -> Bool) -> a -> s -> (Maybe (NonEmpty DerivationIndex), s)
...
isOurTx tx u
  ...
  where
    ...
    txHasRelevantCollateralOutput =
        F.or
            <$> mapM (isOursState . (view #address)) (tx ^. #collateralOutput)
    txHasRelevantWithdrawal =
    ...
    [ Block
        ...
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "97928516bb05fce234d26e99b22b2e68c81841730fb5bd1d835b67374f1de8d7"
                , fee = Nothing
                , txCBOR = Nothing
                , resolvedInputs =
                    [
    ...
    , Block
        ...
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "cd6f2081fdd619c623c71e5cd2a3b5f22289e598b727f325dbba9681ea723079"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
            ...
            , Tx
                { txId =
                    Hash
                        "b17ca3d2b8a991ea4680d1ebd9940a03449b1b6261fbe625d5cae6599726ea41"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
    ...
    , Block
        ...
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "73a5d20740d511e01090247f8aca90e1e550564244173235a1a47589007b9e76"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
            ...
            , Tx
                { txId =
                    Hash
                        "6ed51b05821f0dc130a9411f0d63a241a624fbc8a9c8a2a13da8194ce3c463f4"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
    ...
    , Block
        ...
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "bbc7a1f0de24085ac48a52ee6f89d1815145845a8712547350a7e492385974ab"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "2d04732b41d07e45a2b87c05888f956805f94b108f59e1ff3177860a17c292db"
                }
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "fd545d055c2241802d1518b7fd9f8842c217b54c73364e519ccada5cda07612a"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "e95a6e7da3cd61e923e30b1998b135d40958419e4157a9f05d2f0f194e4d7bba"
                }
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "dffbcd7ca494c4695cc2fd4ec525ffca0861bafb221ee185711f99ca49ae7c11"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "b5d970285a2f8534e94119cd631888c20b3a4ec0707a821f6df5c96650fe01dd"
                }
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "c430d9ae438b9fe1c0898e9c131f3ca2c64c34ef75b202a834b6eabe248eac88"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "63040af5ed7eb2948e2c09a43f946c91d5dd2efaa168bbc5c4f3e989cfc337e6"
                }
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "b5af444a0d95ebd1a55185a0aee2b19835da1c86fc2b43f453f04c002bbc708e"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "1a32e01995225c7cd514e0fe5087f19a6fd597a6071ad4ad1fbf5b20de39670b"
                }
        , transactions = []
        , delegations = []
        }
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "7855c0f101b6761b234058e7e9fd19fbed9fee90a202cca899da1f6cbf29518d"
                }
        , transactions = []
        , delegations = []
        }
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "9007e0513b9fea848034a7203b380cdbbba685073bcfb7d8bb795130d92e7be8"
                }
        , transactions = []
        , delegations = []
        }
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "0af8082504f59eb1b7114981b7dee9009064638420382211118730b45ad385ae"
                }
        , transactions = []
        , delegations = []
        }
    , Block
        ...
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "e65862828230aa340878c8d593f84d59397f10dfa0b183d2d15bea0a5db8ccaf"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
            ...
            , Tx
                { txId =
                    Hash
                        "611ce641f0f9282a35b1678fcd996016833c0de9e83a04bfa1178c8f045196ea"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "4fdff9f1d751dba5a48bc2a14d6dfb21709882a13dad495b856bf76d5adf4bd1"
                }
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "0a5232f1683aaba994fb3774a5e123e2ed4f2842457b67b5309b825550a5f55d"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
            ...
            , Tx
                { txId =
                    Hash
                        "b8e9699ffff40c993d6778f586110b78cd30826feaa5314adf3a2e9894b9313a"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
    ...
    , Block
        ...
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "387b98d4cde710b78ce19e9077b61d6b7a2dff52fd16dcb884b31cd576904c86"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
            ...
            , Tx
                { txId =
                    Hash
                        "7726526b5cc003f71d9629c611397285004b5438eac9a118c2b20e2810e0783e"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
        ...
        { header =
            BlockHeader
                ...
                , parentHeaderHash =
                    Just
                        $ Hash
                            "dffc3506d381361468376227e1c9323a2ffc76011103e3225124f08e6969a73b"
                }
        , transactions =
            [ Tx
                { txId =
                    Hash
                        "9c6fed8fef3b296d4dee6e62ca72b180bf0ed1c13eb5f0445099b2a146235e77"
                , txCBOR = Nothing
                , fee = Nothing
                , resolvedInputs =
                    [
