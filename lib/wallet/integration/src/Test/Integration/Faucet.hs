...
genFaucet encodeAddress genAddresses file ms = do
  ...
  forM [(m, take 10 (genAddresses m)) | m <- ms] $ \(m, addrs) -> do
    let
      mnem = mnemonicToText m
    let
      comment = ("# " <>) $ T.intercalate ", " $ surroundedBy '"' <$> mnem
...
shelleyIntegrationTestFunds =
  ...
  where
    ...
    mirWallets =
      (,defaultAmt) . head . genShelleyAddresses . SomeMnemonic
        <$> mirMnemonics
...
maryIntegrationTestAssets tips =
  maMnemonics
    >>= take 3
...
hwWalletFunds =
  ...
  [
    ( "Ae2tdPwUPEZ9W3XajXS7ypra9BBYkwfvTz1PinD1eSCxHCQjTmw99wBz39y"
  ...
  ,
    ( "Ae2tdPwUPEZ2zpcZVpVoBtGnncG3qSCMQGQ6M4pV2H2K5YyDhqZ7424GKyz"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ7tEnAvFtc3v7eP195XrS3pFgZSSCoa5S8oBFk6ztxVwmUcxA"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZHanmRFbXA1f4pYrFRoBcDMG88CeV4Z57XpMUjqsc8jRz8GE3"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZAyvGMHqdRfLcMuP6Ez6RgYjdyGUFBCeqzPqHbkn4wd3WQrgJ"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ2CdZbNdzsbu8yBU5ZK3XLEQa2pYwsZzgagKCMMdpRLKQKFfX"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEYzrrpt2NccDnv72v1noz2vTXt17UeHPtXuZztcqYM57ncCvfD"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZFyBM66NYnCREpZy43gEpUKwyvYBdf8nK38N6VeKJoawNsVQC"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ7tNoEkK58MrWdR6q6unhSqDgXQvEc2XyRtNLgSWbCe3QZghK"
    , Coin 100_000_000_000
    )
  , -- Legacy Funds (Trezor)
    --
    ...
    ( "Ae2tdPwUPEYzx9hEnPZKT14SfPmsQvpwL46yPRFqzkqBPTDpwwDBiSQSe5H"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZJYmMs1z8Gh2eGZZR3uBqgcQxBevA3rsvWft3U9d6a8dGkcZ8"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEYw6pDMLtHTxBq8LnYCbXeey8AkPeL9DNkibDz4i1SssCTH8R5"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ4wqGZtptW4LxngfZjdmCRaLrsdo3H31CqFkrKH5fxF3GAUdm"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEYxyHGuNmABqY4P7uzzGd6UWVeguwgUrF3tV9AEptExgAbb2Ds"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ9wCuUSgeHEC7jMhiHS8hXWx8w1Vtt9ZxrzYoKDPbTKhdPAfJ"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ8Vt43wsBaAzHnEdvjwPnjAoWLC1xeJeNeWAvvZnNDAMwZ22b"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEYx21tKjtE2WzQsmsxNdVZQxCCgojUxMFtmCYR9gqqwXhBPm57"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEYxVQrJm6PuWkjgNadiUV3YfC2sCmQFDZqwuzNFGj7Tgp8n1Bi"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEYwBbU6ghpjWkNw81wZ6LdyWdZVMdoScDPiSV5ZhwSJzkZqus3"
    , Coin 100_000_000_000
    )
  , -- Legacy Funds (Trezor)
    --
    ...
    ( "Ae2tdPwUPEZBvaca39j3KRRikqY3AGFseAtgBLdnV8pDArUS5pqyMAzXUzY"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ4MemwEvUPeHWHckYjfYGiU7qyLCJ6MumaU5c64YVboeVBU4o"
    , Coin 100_000_000_000
    )
  ,
  ...
  ,
    ( "Ae2tdPwUPEYygErppRsoEqXEyPGxEFsKVoa2BFKMG3prWh6sFi8VSgW4h3k"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZCWwt43jbnf3RjEBqixpjkzMdTB9cyt7zJjVnq8PTnF55rHQL"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEYzbmFy6Mbn1WjwtQJyj71Wqj27jz9QpPty1KoyJL3tQh4XBkW"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZ4m5XyBU9c41sareSBsLMoSn97co3XMnaGtuQDCPRywXp6bt5"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZNLXT48whvAoRTn9bMeZweHhPqG7xFDzCrKfzGu8Ku8myrRcj"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZMpnbSJauTkyFvaxzmcxbz29h4ogiQemoMDEwun5tAEQnHaV2"
    , Coin 100_000_000_000
    )
  ,
    ( "Ae2tdPwUPEZEaxZqj8oXrCPuA3Ehaa5fa9kPAgpdLmgoSeKipZEPWo5qeQF"
    , Coin 100_000_000_000
    )
  , -- Legacy Funds (Ledger)
    --
