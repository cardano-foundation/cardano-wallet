        ...
        wits' =
          ...
          where
            ...
            mintBurnScriptsKeyHashes =
                let (_, toMint, toBurn, _, _, _) =
                        fromCardanoTx witCountCtx
                            $ Cardano.makeSignedTransaction wits body
                in  -- Note that we use 'nub' here because multiple scripts can share
...
mkTxSkeleton
    ...
    -> SelectionSkeleton
    -> TxSkeleton
mkTxSkeleton witness context skeleton =
    TxSkeleton
            ...
            TxWitnessShelleyUTxO ->
                ...
                if numberOf_ScriptVkeyWitnessesForPayment == 0
                    then
                        ...
                        if numberOf_ScriptVkeyWitnessesForDelegation == 0
                            then
