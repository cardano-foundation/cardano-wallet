...
import Test.QuickCheck
    ...
    arbitraryASCIIChar, arbitraryBoundedIntegral, arbitrarySizedNatural, choose,
    chooseInt, chooseInteger, elements, frequency, infiniteListOf,
    liftArbitrary, liftShrink2, listOf, listOf1, oneof, scale, shrink,
    shrinkList, sized, vector, vectorOf )
