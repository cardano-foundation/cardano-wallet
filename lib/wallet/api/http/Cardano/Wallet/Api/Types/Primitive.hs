...
import Cardano.Wallet.Primitive.Types.TokenBundle qualified as W
import Cardano.Wallet.Primitive.Types.TokenMap qualified as W
...
instance ToJSON (ApiT W.TokenBundle) where
  ...
  toJSON (ApiT (W.TokenBundle c ts)) =
    object
