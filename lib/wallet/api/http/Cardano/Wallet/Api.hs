...
type ListStakePools =
    "stake-pools"
        ...
        :> Get '[JSON] [ApiT StakePool]

type JoinStakePool n =
    "stake-pools"
        :> Capture "stakePoolId" ApiPoolSpecifier
        :> "wallets"
        :> Capture "walletId" (ApiT WalletId)
...
type GetSharedWalletUtxoSnapshot =
    "shared-wallets"
        :> Capture "walletId" (ApiT WalletId)
        :> "utxo"
        :> Get '[JSON] ApiWalletUtxoSnapshot
