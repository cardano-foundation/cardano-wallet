    ...
    it
        ...
        $ \ctx -> runResourceT $ do
            ...
            decodeErrorInfo response
                `Lifted.shouldBe` NoSuchWallet (ApiErrorNoSuchWallet $ sourceWallet ^. #id)
