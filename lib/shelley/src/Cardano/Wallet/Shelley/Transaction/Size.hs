...
--             | U8                   --     1 bytes
instance MaxSizeOf Address 'Mainnet ShelleyKey where maxSizeOf = 76
instance MinSizeOf Address 'Mainnet ShelleyKey where minSizeOf = 68
...
--             | U8                   --     1 bytes
instance MaxSizeOf Address ('Testnet pm) ShelleyKey where maxSizeOf = 83
instance MinSizeOf Address ('Testnet pm) ShelleyKey where minSizeOf = 75
