...
echo "--- Build"
nix-build -A benchmarks.cardano-wallet-jormungandr -o $bench_name
...
./$bench_name/cardano-wallet-jormungandr* --json $bench_name.json -o $bench_name.html | tee $bench_name.txt
