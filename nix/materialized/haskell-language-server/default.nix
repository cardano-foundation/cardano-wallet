  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "stan".revision = (((hackage."stan")."0.0.1.0").revisions).default;
        ...
        "hls-tactics-plugin".revision = (((hackage."hls-tactics-plugin")."1.7.0.0").revisions).default;
        ...
        "hls-haddock-comments-plugin".revision = (((hackage."hls-haddock-comments-plugin")."1.1.0.0").revisions).default;
        ...
        "hls-splice-plugin".revision = (((hackage."hls-splice-plugin")."1.0.2.0").revisions).default;
        ...
        "hls-stan-plugin".revision = (((hackage."hls-stan-plugin")."1.0.0.0").revisions).default;
        "hls-stan-plugin".flags.pedantic = false;
        ...
        "hls-brittany-plugin".revision = (((hackage."hls-brittany-plugin")."1.0.2.2").revisions).default;
        ...
        "base64".revision = (((hackage."base64")."0.4.2.4").revisions).default;
        ...
        "microaeson".revision = (((hackage."microaeson")."0.1.0.1").revisions).default;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "hls-stan-plugin".components.library.planned = lib.mkOverride 900 true;
