  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "ip".revision = (((hackage."ip")."1.7.4").revisions).default;
        ...
        "regex-pcre-builtin".revision = (((hackage."regex-pcre-builtin")."0.95.2.3.8.44").revisions).default;
        ...
        "bytesmith".revision = (((hackage."bytesmith")."0.3.8.0").revisions).default;
        ...
        "bytebuild".revision = (((hackage."bytebuild")."0.3.9.0").revisions).default;
        ...
        "hspec-hedgehog".revision = (((hackage."hspec-hedgehog")."0.0.1.2").revisions).default;
        ...
        "persistent".revision = (((hackage."persistent")."2.13.2.1").revisions).default;
        ...
        "contiguous".revision = (((hackage."contiguous")."0.6.1").revisions).default;
        ...
        "string-qq".revision = (((hackage."string-qq")."0.0.4").revisions).default;
        ...
        "byteslice".revision = (((hackage."byteslice")."0.2.6.0").revisions).default;
        ...
        "criterion".revision = (((hackage."criterion")."1.5.12.0").revisions).default;
  ...
  extras = hackage:
    {
      packages = {
        ...
        bech32-th = ./.plan.nix/bech32-th.nix;
        ...
        cardano-sl-x509 = ./.plan.nix/cardano-sl-x509.nix;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "cardano-data" = { flags = {}; };
          "freer-extras" = { flags = {}; };
          "bech32-th" = { flags = { "release" = lib.mkOverride 900 false; }; };
          "measures" = {
            flags = { "development" = lib.mkOverride 900 false; };
            };
          "cardano-prelude" = {
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "string-qq".components.library.planned = lib.mkOverride 900 true;
          ...
          "text-class".components.tests."unit".planned = lib.mkOverride 900 true;
          ...
          "run-st".components.library.planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet".components.tests."integration".planned = lib.mkOverride 900 true;
          ...
          "dbvar".components.tests."unit".planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet-cli".components.tests."unit".planned = lib.mkOverride 900 true;
          ...
          "tuples".components.library.planned = lib.mkOverride 900 true;
          ...
          "primitive-offset".components.library.planned = lib.mkOverride 900 true;
          ...
          "strict-non-empty-containers".components.tests."unit".planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet-core".components.tests."unit".planned = lib.mkOverride 900 true;
          ...
          "contiguous".components.library.planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet-test-utils".components.tests."unit".planned = lib.mkOverride 900 true;
          "cardano-wallet-launcher".components.tests."unit".planned = lib.mkOverride 900 true;
          ...
          "regex-pcre-builtin".components.library.planned = lib.mkOverride 900 true;
          ...
          "should-not-typecheck".components.library.planned = lib.mkOverride 900 true;
          ...
          "ip".components.library.planned = lib.mkOverride 900 true;
          ...
          "cardano-sl-x509".components.library.planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet-core".components.benchmarks."db".planned = lib.mkOverride 900 true;
          ...
          "cardano-numeric".components.tests."unit".planned = lib.mkOverride 900 true;
          "cardano-crypto-praos".components.library.planned = lib.mkOverride 900 true;
          "bytesmith".components.library.planned = lib.mkOverride 900 true;
          ...
          "bytebuild".components.library.planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet".components.tests."unit".planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet".components.benchmarks."restore".planned = lib.mkOverride 900 true;
          ...
          "cardano-wallet".components.benchmarks."latency".planned = lib.mkOverride 900 true;
