  ...
  extras = hackage:
    {
      packages = {
        ...
        cardano-ledger-babbage = ./.stack-to-nix.cache.18;
        cardano-ledger-alonzo = ./.stack-to-nix.cache.19;
        cardano-ledger-alonzo-test = ./.stack-to-nix.cache.20;
        ...
        compact-map = ./.stack-to-nix.cache.35;
        ...
        cardano-cli = ./.stack-to-nix.cache.41;
        cardano-node = ./.stack-to-nix.cache.42;
        cardano-git-rev = ./.stack-to-nix.cache.43;
        trace-dispatcher = ./.stack-to-nix.cache.44;
        trace-resources = ./.stack-to-nix.cache.45;
        trace-forward = ./.stack-to-nix.cache.46;
        cardano-prelude = ./.stack-to-nix.cache.47;
        cardano-prelude-test = ./.stack-to-nix.cache.48;
        cardano-sl-x509 = ./.stack-to-nix.cache.49;
        flat = ./.stack-to-nix.cache.50;
        goblins = ./.stack-to-nix.cache.51;
        hedgehog-extras = ./.stack-to-nix.cache.52;
        ...
        purescript-bridge = ./.stack-to-nix.cache.61;
        io-classes = ./.stack-to-nix.cache.62;
        io-sim = ./.stack-to-nix.cache.63;
        ...
        strict-stm = ./.stack-to-nix.cache.79;
        typed-protocols = ./.stack-to-nix.cache.80;
        typed-protocols-cborg = ./.stack-to-nix.cache.81;
        typed-protocols-examples = ./.stack-to-nix.cache.82;
        cardano-client = ./.stack-to-nix.cache.83;
        ntp-client = ./.stack-to-nix.cache.84;
        ouroboros-consensus-mock = ./.stack-to-nix.cache.85;
        plutus-core = ./.stack-to-nix.cache.86;
        plutus-ledger-api = ./.stack-to-nix.cache.87;
        plutus-tx = ./.stack-to-nix.cache.88;
        plutus-tx-plugin = ./.stack-to-nix.cache.89;
        plutus-ghc-stub = ./.stack-to-nix.cache.90;
        prettyprinter-configurable = ./.stack-to-nix.cache.91;
        word-array = ./.stack-to-nix.cache.92;
        ekg-forward = ./.stack-to-nix.cache.93;
