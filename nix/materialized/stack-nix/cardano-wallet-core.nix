    ...
    components = {
      "library" = {
        ...
        modules = [
          ...
          "Cardano/Wallet/DB/Sqlite/WrapSTM"
      ...
      tests = {
        "unit" = {
          ...
          modules = [
            ...
            "Cardano/Wallet/DB/PureSpec"
            "Cardano/Wallet/DB/SqliteSpec"
            "Cardano/Wallet/DB/Sqlite/TypesSpec"
            "Cardano/Wallet/DB/StateMachine"
            "Cardano/Wallet/DB/Stores/CheckpointsSpec"
            "Cardano/Wallet/DB/Stores/Fixtures"
            "Cardano/Wallet/DB/Stores/TransactionsSpec"
