    ...
    components = {
      "library" = {
        ...
        modules = [
          ...
          "Cardano/Wallet/DB/Stores/Checkpoints/Model"
          "Cardano/Wallet/DB/Stores/Checkpoints/Sqlite"
          "Cardano/Wallet/DB/Stores/TxHistory/Model"
          "Cardano/Wallet/DB/Stores/TxHistory/Sqlite"
          "Cardano/Wallet/DB/Stores/TxHistory/Update"
