  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "retry".revision = (((hackage."retry")."0.9.2.0").revisions).default;
        ...
        "hspec-discover".revision = (((hackage."hspec-discover")."2.9.7").revisions).default;
        ...
        "kan-extensions".revision = (((hackage."kan-extensions")."5.2.4").revisions).default;
        ...
        "hspec-core".revision = (((hackage."hspec-core")."2.9.7").revisions).default;
        ...
        "hspec".revision = (((hackage."hspec")."2.9.7").revisions).default;
        ...
        "hw-hedgehog".revision = (((hackage."hw-hedgehog")."0.1.1.1").revisions).default;
        ...
        "hw-hspec-hedgehog".revision = (((hackage."hw-hspec-hedgehog")."0.1.1.1").revisions).default;
