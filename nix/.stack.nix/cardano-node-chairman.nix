{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "cardano-node-chairman"; version = "1.25.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchgit {
      ...
      rev = "9d62ffad185eafaabc35682355602fb5b61d33f6";
      sha256 = "0krfbhxx7xcrlfi3l4hnngd7wxcv2vgbvmzn9nnzf057s6rwwxck";
      });
