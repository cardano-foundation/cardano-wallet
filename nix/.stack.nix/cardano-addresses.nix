{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "cardano-addresses"; version = "3.5.0"; };
      license = "Apache-2.0";
      copyright = "2021 IOHK";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchgit {
      ...
      rev = "9fe7084c9c53b9edf3eba34ee8459c896734ac7a";
      sha256 = "0pv63yy8d5cn7bylh2inj66ls34bl2faczn88a7b0daz2wr2cbfi";
      });
