{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "cardano-addresses"; version = "2.1.0"; };
      license = "Apache-2.0";
      copyright = "2020 IOHK";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchgit {
      ...
      rev = "1399751501b03346265b2e429e5832bacd6df279";
      sha256 = "0dsprpk1sk2kk1s1m4wwfhk9ngwrni7fsx3lmmy19phbv39rnlc5";
      });
