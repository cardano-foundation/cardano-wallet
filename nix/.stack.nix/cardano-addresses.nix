{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "cardano-addresses"; version = "3.4.0"; };
      license = "Apache-2.0";
      copyright = "2021 IOHK";
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchgit {
      ...
      rev = "430c5f98b735c8fea6e2d552650a9f74b0fd477d";
      sha256 = "0hr6541alfbb5fddjdn4hjx2rfl8j4bld0846hlvav5brn8xv7fm";
      });
