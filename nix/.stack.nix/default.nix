  ...
  extras = hackage:
    {
      packages = {
        ...
        cardano-ledger-shelley = ./cardano-ledger-shelley.nix;
        cardano-ledger-shelley-test = ./cardano-ledger-shelley-test.nix;
        ...
        trace-dispatcher = ./trace-dispatcher.nix;
        trace-resources = ./trace-resources.nix;
        trace-forward = ./trace-forward.nix;
