  ...
  extras = hackage:
    {
      packages = {
        ...
        "base16" = (((hackage.base16)."0.3.0.1").revisions).default;
        ...
        "generic-monoid" = (((hackage.generic-monoid)."0.1.0.1").revisions).default;
        "generics-sop" = (((hackage.generics-sop)."0.5.1.1").revisions).default;
        "gray-code" = (((hackage.gray-code)."0.3.1").revisions).default;
        "hedgehog" = (((hackage.hedgehog)."1.0.5").revisions).default;
        "io-streams" = (((hackage.io-streams)."1.5.2.0").revisions).default;
        "katip" = (((hackage.katip)."0.8.5.0").revisions).default;
        ...
        "prometheus" = (((hackage.prometheus)."2.2.2").revisions).default;
        "regex-posix-clib" = (((hackage.regex-posix-clib)."2.7").revisions).default;
        "snap-core" = (((hackage.snap-core)."1.0.4.2").revisions).default;
        "snap-server" = (((hackage.snap-server)."1.1.2.0").revisions).default;
        ...
        "tasty-hedgehog" = (((hackage.tasty-hedgehog)."1.0.1.0").revisions).default;
        "text" = (((hackage.text)."1.2.4.0").revisions).default;
        "text-ansi" = (((hackage.text-ansi)."0.1.1").revisions).default;
        "text-zipper" = (((hackage.text-zipper)."0.11").revisions).default;
        "th-lift-instances" = (((hackage.th-lift-instances)."0.1.18").revisions).default;
        "transformers-except" = (((hackage.transformers-except)."0.1.1").revisions).default;
        "unordered-containers" = (((hackage.unordered-containers)."0.2.13.0").revisions).default;
        "websockets" = (((hackage.websockets)."0.12.7.2").revisions).default;
