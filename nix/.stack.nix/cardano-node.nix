{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "cardano-node"; version = "1.13.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (system.isLinux && flags.systemd) (hsPkgs."systemd" or (errorHandler.buildDepError "systemd"))) ++ (if system.isWindows
