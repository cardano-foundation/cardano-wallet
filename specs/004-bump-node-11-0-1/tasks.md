...
| T028 | delta-store | `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c bash -lc 'shopt -s globstar; fourmolu --mode check lib/delta-store/src/**/*.hs lib/delta-store/test/unit/**/*.hs'`; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c hlint lib/delta-store/src lib/delta-store/test/unit` -> No hints; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c cabal-fmt --check lib/delta-store/delta-store.cabal`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#packages.x86_64-linux.tests.delta-store.unit` -> `/nix/store/0308la57ysqcm8w9ajisa2sw71m0x6sq-delta-store-test-unit-0.2026.4.17`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#checks.x86_64-linux.delta-store.unit` -> `/nix/store/wla8hwybvfjmkipz5rv9bkgsp8qc32h4-delta-store-test-unit-0.2026.4.17-check`; `/nix/store/0308la57ysqcm8w9ajisa2sw71m0x6sq-delta-store-test-unit-0.2026.4.17/bin/unit` -> 3 examples, 0 failures |
| T029 | cardano-wallet | `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c bash -lc 'shopt -s globstar; fourmolu --mode check lib/wallet/src/**/*.hs lib/wallet/mock-token-metadata/src/**/*.hs lib/wallet/exe/**/*.hs lib/wallet/extra/Plutus/**/*.hs'`; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c hlint lib/wallet/src lib/wallet/mock-token-metadata/src lib/wallet/exe lib/wallet/extra/Plutus` -> No hints; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c cabal-fmt --check lib/wallet/cardano-wallet.cabal`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#legacyPackages.x86_64-linux.hsPkgs.cardano-wallet.components.library .#legacyPackages.x86_64-linux.hsPkgs.cardano-wallet.components.sublibs.mock-token-metadata .#legacyPackages.x86_64-linux.hsPkgs.cardano-wallet.components.exes.wallet-key-export .#legacyPackages.x86_64-linux.hsPkgs.cardano-wallet.components.exes.mock-token-metadata-server` -> `/nix/store/k5rmwqj0d431rs35w9cf554zx8p4q3h1-cardano-wallet-lib-cardano-wallet-0.2026.4.17`, `/nix/store/dm2qmlp3kyz7zz5l18vfwwnfpvf1z0ng-cardano-wallet-lib-mock-token-metadata-0.2026.4.17`, `/nix/store/fwi8fgyqsafs1h4zb60354qqjiaz7383-cardano-wallet-exe-wallet-key-export-0.2026.4.17`, `/nix/store/1rscpsayknyxsq2rsyp0rygc8wn3nwri-cardano-wallet-exe-mock-token-metadata-server-0.2026.4.17`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#packages.x86_64-linux.tests.cardano-wallet.wallet-key-export-test` -> `/nix/store/fdhlhyfa79p9ypn50z9a3l52adcv7q8q-cardano-wallet-test-wallet-key-export-test-0.2026.4.17`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#checks.x86_64-linux.cardano-wallet.wallet-key-export-test` -> `/nix/store/ihdafc80k6kyg7v24c3gnwi6wlly5mpr-cardano-wallet-test-wallet-key-export-test-0.2026.4.17-check`; `PATH=/nix/store/fwi8fgyqsafs1h4zb60354qqjiaz7383-cardano-wallet-exe-wallet-key-export-0.2026.4.17/bin:$PATH /nix/store/fdhlhyfa79p9ypn50z9a3l52adcv7q8q-cardano-wallet-test-wallet-key-export-test-0.2026.4.17/bin/wallet-key-export-test` -> All tests passed; 6 QuickCheck groups passed 20 tests each |
| T030 | cardano-wallet-api | `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c bash -lc 'shopt -s globstar; fourmolu --mode check lib/api/src/**/*.hs'`; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c hlint lib/api/src` -> No hints; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c cabal-fmt --check lib/api/cardano-wallet-api.cabal`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#legacyPackages.x86_64-linux.hsPkgs.cardano-wallet-api.components.library` -> `/nix/store/wdx1b1vidhgm9wr6hddgm6yi6rd53r49-cardano-wallet-api-lib-cardano-wallet-api-0.2026.4.17`; no Cabal test-suite |
| T031 | cardano-wallet-application-tls | `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c bash -lc 'shopt -s globstar; fourmolu --mode check lib/application-tls/lib/**/*.hs lib/application-tls/test/**/*.hs'`; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c hlint lib/application-tls/lib lib/application-tls/test` -> No hints; `nix develop --accept-flake-config --allow-import-from-derivation --quiet -c cabal-fmt --check lib/application-tls/cardano-wallet-application-tls.cabal`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#packages.x86_64-linux.tests.cardano-wallet-application-tls.unit` -> `/nix/store/74qrdpkm0ya1936v5prgyicaf8qlvlwx-cardano-wallet-application-tls-test-unit-0.2026.4.17`; `nix build --accept-flake-config --allow-import-from-derivation --no-link --print-out-paths .#checks.x86_64-linux.cardano-wallet-application-tls.unit` -> `/nix/store/6z0745q49g85v396izp9xzsqk4l5klbs-cardano-wallet-application-tls-test-unit-0.2026.4.17-check`; `cd /code/cardano-wallet/lib/application-tls && /nix/store/74qrdpkm0ya1936v5prgyicaf8qlvlwx-cardano-wallet-application-tls-test-unit-0.2026.4.17/bin/unit` -> 6 examples, 0 failures |
...
- [X] T028 [US1] Adapt and close `delta-store` in `/code/cardano-wallet/lib/delta-store/delta-store.cabal` and `/code/cardano-wallet/lib/delta-store/`
- [X] T029 [US2] Adapt and close `cardano-wallet` in `/code/cardano-wallet/lib/wallet/cardano-wallet.cabal` and `/code/cardano-wallet/lib/wallet/`
- [X] T030 [US2] Adapt and close `cardano-wallet-api` in `/code/cardano-wallet/lib/api/cardano-wallet-api.cabal` and `/code/cardano-wallet/lib/api/`
- [X] T031 [US1] Adapt and close `cardano-wallet-application-tls` in `/code/cardano-wallet/lib/application-tls/cardano-wallet-application-tls.cabal` and `/code/cardano-wallet/lib/application-tls/`
