...
> | --- | --- | ---
> | `master` branch | [alonzo-white-1.4](https://github.com/input-output-hk/cardano-node/releases/tag/alonzo-white-1.4) | [1.4.0](https://github.com/input-output-hk/smash/releases/tag/1.4.0)
