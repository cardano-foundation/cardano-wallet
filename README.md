...
> | --- | --- | ---
> | `master` branch | [alonzo-white-1.3](https://github.com/input-output-hk/cardano-node/releases/tag/alonzo-white-1.3) | [1.4.0](https://github.com/input-output-hk/smash/releases/tag/1.4.0)
