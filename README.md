...
> | --- | --- | --- | ---
> | `master` branch | [None](https://github.com/input-output-hk/cardano-wallet-jormungandr) | [1.22.1](https://github.com/input-output-hk/cardano-node/releases/tag/1.22.1) | [1.2.0](https://github.com/input-output-hk/smash/releases/tag/1.2.0)
